  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
        ...
        <Tabs className="m-5 bg-white relative z-10">
          <Tabs.Item active title="Hindi">
        ...
        <div className="grid place-items-center sm:mt-20 relative z-10">
          <img
        ...
        <section className="bg-gray-50 rounded-md py-10 my-5 relative z-10">
          ...
          <div className="mx-auto max-w-7xl overflow-x-auto">
            <div className="flex justify-start items-center space-x-6">
              ...
              <div className="flex-shrink-0 w-64 bg-white p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
                <h3 className="text-lg font-semibold mb-4">Anonymous</h3>
                <p className="text-gray-600">
