        ...
        <header className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <nav className="container flex mx-auto max-w-screen-xl">
                ...
                <Link to="/" className="flex items-center">
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">E-Commerce Website</span>
                    </Link>
                ...
                <div className={`lg:flex flex-grow justify-end ${isMobileMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu-2">
                        ...
                        <li>
                          <NavLink to="/shop" onClick={() => setIsMobileMenuOpen(false)} className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Shop</NavLink>
                        </li>
                        <li>
