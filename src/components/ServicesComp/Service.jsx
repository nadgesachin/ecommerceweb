      ...
      <div className="flex justify-center p-5 mt-30 cursor-pointer">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <Card
            ...
            description="Explore trends effortlessly with our digitized grocery shop—style, convenience, and curated fashion at your fingertips."
            serviceId="grocery"
          />
          <Card
          ...
          <Card
            ...
            description="Elevate your fitness journey with our digitized mobile shop—innovation, motivation, and progress for a stronger you!"
            serviceId="mobile"
          />
          <Card
            ...
            description="Revolutionize your dining experience with our digitalized clothes shop—convenience, variety, and flavors delivered to your doorstep!"
            serviceId="clothes"
          />
          <Card
            imageSrc={madical}
            title="Medical Store Management"
            description="Elevate your special day with our digitized medical store—elegance, creativity, and unforgettable celebrations."
            serviceId="medical"
          />
          <Card
            imageSrc="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/14/49/e7/02/thyme-full-view.jpg?w=600&h=-1&s=1"
            title="Restaurant Management"
            description="Adorn yourself uniquely with our digitized restaurant shop—elegance, craftsmanship, and timeless beauty for every moment."
